...
public class UserView {
    ...
    private void createUser() {
        try {
            ...
            // Validación rápida: si alguno es null (cancelado) o vacío
            ...
            String role = (String) JOptionPane.showInputDialog(
                    ...
                    null,
                    roles,
                    roles[1]  // valor por defecto
            );
            if (role == null) return;

            // Confirmar si está activo
            int activeOption = JOptionPane.showConfirmDialog(
                    null,
                    "¿El usuario estará activo?",
                    "Estado del usuario",
                    JOptionPane.YES_NO_OPTION
            );
            boolean isActive = (activeOption == JOptionPane.YES_OPTION);
            ...
            data.put("role", role);
            data.put("active", String.valueOf(isActive));
