...
public class BookService {
    ...
    public Book createBook(Book book) throws BadRequestException, ConflictException, ServiceException, DataAccessException {
        if (book.getTitle() == null || book.getTitle().isBlank() || book.getIsbn() == null || book.getIsbn().isBlank() || book.getCategory() == 0 ) {
            throw new BadRequestException("Título, ISBN o Categoria inválido");
        }
