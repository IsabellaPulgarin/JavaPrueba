...
public class LoanView {
    ...
    private void showAssistantMenu(User currentUser) {
        String[] options = { "Ver mis préstamos","Solicitar prestamo", "Volver" };
        int choice;
        do {
            choice = JOptionPane.showOptionDialog(
                    null,
            ...
            if (choice == 0) {
                ...
                registerLoanAssistant(currentUser.getId());
            }
    ...
    private void registerLoanAssistant(int userId) {
        try {
            int idUser;
            idUser = userId;
            int idBook = Integer.parseInt(JOptionPane.showInputDialog("ID del libro:"));
